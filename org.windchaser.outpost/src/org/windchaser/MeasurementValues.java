...
public class MeasurementValues {
	 ...
	 * 
	 * @param source
	 *            the {@link Collector} that fires this event, not
	 *            <code>null</code>
	 * @param tickCount
	 *            number of ticks that were detected during the measurement,
	 *            must be >=0
	 * @param durationMs
	...
	/**
	 * Returns the number of ticks detected during the measurement. One tick
	 * represents a half turn of the anemometer. By the number of ticks per time
	 * unit, the wind speed can derived.
	 * 
